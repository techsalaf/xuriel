...
import { ssrRenderAttrs, ssrGetDirectiveProps, ssrInterpolate, ssrRenderList, ssrRenderComponent, ssrRenderStyle, ssrRenderAttr, ssrRenderClass } from "vue/server-renderer";
import { s as sharedComposable } from "../ssr.js";
import { f as footerData, _ as _sfc_main$1 } from "./LanguageSwitch-zTZKOuWO.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="col-lg-2 col-md-3 col-sm-4 mb-20"><h5 class="footer-title">${ssrInterpolate(((_d = unref(footerCenter)) == null ? void 0 : _d.name) ? unref(footerCenter).name : _ctx.trans("Services​"))}</h5>`);
      ...
      if (unref(NEWSLETTER_API) || ((_j = Object.entries(_ctx.$page.props.languages)) == null ? void 0 : _j.length) > 1) {
        ...
        if (unref(NEWSLETTER_API)) {
          _push(`<!--[--><h5 class="footer-title">${ssrInterpolate(_ctx.trans("Newsletter"))}</h5><p style="${ssrRenderStyle({ "color": "#1d4398" })}">${ssrInterpolate(_ctx.trans("Join & get important new regularly"))}</p><form class="d-flex"><input${ssrRenderAttr("value", unref(email))} type="email" placeholder="Enter your email*"><button type="submit">${ssrInterpolate(_ctx.trans("Send"))}</button></form><p class="note">${ssrInterpolate(_ctx.trans("We only send interesting and relevant emails."))}</p><!--]-->`);
        } else {
          _push(`<!---->`);
        }
        if (((_k = Object.entries(_ctx.$page.props.languages)) == null ? void 0 : _k.length) > 1) {
          _push(`<!--[--><h5 class="footer-title fs-6 mb-2 mt-2">${ssrInterpolate(_ctx.trans("Language"))}</h5>`);
      ...
      _push(`</li></ul></div><div class="col-lg-4 order-lg-2"><p class="mb-15 text-center opacity-50">${ssrInterpolate(_ctx.trans("Copyright"))} @${ssrInterpolate(unref(year))} ${ssrInterpolate(_ctx.$page.props.app_name || "")}. </p></div></div></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=Footer-LB6tgVPy.js.map
