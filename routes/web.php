...
Route::get('/jobs/{job}/apply', [WEB\JobController::class, 'apply'])->name('jobs.apply.form')->middleware('auth');
Route::post('/jobs/{job}/apply', [WEB\JobController::class, 'applyStore'])->name('jobs.apply.submit')->middleware('auth');
