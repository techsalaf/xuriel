                ...
                <form @submit.prevent="formSubmit">
                  <div class="row">
                    <div class="col-md-5">
                      <div class="input-box">
                        <div class="label">
                          {{ trans("Search for jobs, skills or our services") }}
                        </div>
                        <input
                          type="text"
                    ...
                    <div class="col-md-4">
                      <div class="input-box border-left">
                        <div class="label">{{ trans("Choose a Service or Skill...") }}</div>
                        <NiceSelect
              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="text-center counter-block-two mt-15 wow fadeInUp">
                    <p class="text-white">{{ trans("Trusted By") }}</p>
                    <div class="text-white main-count fw-500">{{ home.hero.item1 }}</div>
                    <p class="text-white">{{ trans("Businesses WorldWide") }}</p>
                  </div>
                  <!-- /.counter-block-two -->
                </div>
                <div class="col-sm-4">
                  <div
                    class="text-center counter-block-two mt-15 wow fadeInUp" data-wow-delay="0.2s">
                    <p class="text-white">{{ trans("The Top") }}</p>
                    <div class="text-white main-count fw-500">{{ home.hero.item2 }}</div>
                    <p class="text-white">{{ trans("Skilled Professionals") }}</p>
                  </div>
                  <!-- /.counter-block-two -->
                </div>
                <div class="col-sm-4">
                  ...
                  >
                    <p class="text-white">{{ trans("More Than") }}</p>
                    <div class="text-white main-count fw-500">{{ home.hero.item3 }}</div>
                    <p class="text-white">{{ trans("Lives Transformed") }}</p>
                  </div>
                  <!-- /.counter-block-two -->
                </div>
              </div>
